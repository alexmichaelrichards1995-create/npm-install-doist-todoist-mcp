...
const activity_client_1 = require("./clients/activity-client");
const app_client_1 = require("./clients/app-client");
const backup_client_1 = require("./clients/backup-client");
const billing_client_1 = require("./clients/billing-client");
const comment_client_1 = require("./clients/comment-client");
const email_client_1 = require("./clients/email-client");
const folder_client_1 = require("./clients/folder-client");
const id_mapping_client_1 = require("./clients/id-mapping-client");
const insights_client_1 = require("./clients/insights-client");
const label_client_1 = require("./clients/label-client");
const productivity_client_1 = require("./clients/productivity-client");
const project_client_1 = require("./clients/project-client");
const reminder_client_1 = require("./clients/reminder-client");
const section_client_1 = require("./clients/section-client");
const task_client_1 = require("./clients/task-client");
const template_client_1 = require("./clients/template-client");
const ui_extension_client_1 = require("./clients/ui-extension-client");
const upload_client_1 = require("./clients/upload-client");
...
const sync_request_1 = require("./transport/sync-request");
...
class TodoistApi {
    ...
    options) {
        ...
        this.taskClient = new task_client_1.TaskClient(clientDeps);
        this.projectClient = new project_client_1.ProjectClient(clientDeps);
        this.sectionClient = new section_client_1.SectionClient(clientDeps);
        this.labelClient = new label_client_1.LabelClient(clientDeps);
        this.commentClient = new comment_client_1.CommentClient(clientDeps);
        this.reminderClient = new reminder_client_1.ReminderClient(clientDeps);
        this.insightsClient = new insights_client_1.InsightsClient(clientDeps);
        this.folderClient = new folder_client_1.FolderClient(clientDeps);
        this.templateClient = new template_client_1.TemplateClient(clientDeps);
        this.uploadClient = new upload_client_1.UploadClient(clientDeps);
        this.backupClient = new backup_client_1.BackupClient(clientDeps);
        this.emailClient = new email_client_1.EmailClient(clientDeps);
        this.idMappingClient = new id_mapping_client_1.IdMappingClient(clientDeps);
        this.activityClient = new activity_client_1.ActivityClient(clientDeps);
        this.productivityClient = new productivity_client_1.ProductivityClient(clientDeps);
        this.workspaceClient = new workspace_client_1.WorkspaceClient(clientDeps);
        this.billingClient = new billing_client_1.BillingClient(clientDeps);
        this.appClient = new app_client_1.AppClient(clientDeps);
        this.uiExtensionClient = new ui_extension_client_1.UiExtensionClient(clientDeps);
    }
    /**
    ...
    async sync(syncRequest, requestId) {
        var _a;
        return (0, sync_request_1.performSyncRequest)({
            authToken: this.authToken,
            syncApiBase: this.syncApiBase,
            customFetch: this.customFetch,
        }, syncRequest, { requestId, hasSyncCommands: Boolean((_a = syncRequest.commands) === null || _a === void 0 ? void 0 : _a.length) });
    }
    /**
     ...
     */
    async cancelPlan(args, requestId) {
     ...
     */
    async reactivatePlan(requestId) {
     ...
     */
    async upgradeToPro(args, requestId) {
     ...
     * @returns A promise that resolves to the checkout session URL.
     */
    async startProTrial(args, requestId) {
     ...
     */
    async createProBillingPortalSession(args, requestId) {
     ...
     * @returns A promise that resolves to the checkout session URL.
     */
    async upgradeWorkspace(args, requestId) {
     ...
     * @returns A promise that resolves to the checkout session URL.
     */
    async startWorkspaceTrial(args, requestId) {
     ...
     * @returns A promise that resolves to the billing portal URL.
     */
    async createWorkspaceBillingPortalSession(args, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async updateApp(appId, args, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async deleteApp(appId, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async getAppSecrets(appId, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async resetAppClientSecret(appId, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async revokeAppTokens(appId, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async uploadAppIcon(args, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async getAppTestToken(appId, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async createAppTestToken(appId, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async getAppDistributionToken(appId, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async getAppVerificationToken(appId, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async resetAppVerificationToken(appId, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async getAppByDistributionToken(distributionToken, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async getAppWebhook(appId, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async updateAppWebhook(args, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async deleteAppWebhook(appId, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async getAppInstallations(requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async installApp(args, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async getAppInstallation(installationId, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async updateAppInstallation(installationId, args, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async uninstallApp(installationId, requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async getUserAuthorizations(requestId) {
     ...
     * Requires the `dev:app_console` scope.
     */
    async revokeUserAuthorization(args, requestId) {
