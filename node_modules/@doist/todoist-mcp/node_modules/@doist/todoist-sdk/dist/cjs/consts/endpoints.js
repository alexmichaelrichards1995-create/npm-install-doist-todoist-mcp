...
exports.APP_ICON_SIZES = exports.ENDPOINT_REST_USER_AUTHORIZATIONS_DELETE = exports.ENDPOINT_REST_USER_AUTHORIZATIONS = exports.ENDPOINT_REST_APPS_UI_EXTENSIONS_INSTALLED = exports.ENDPOINT_REST_APPS_UI_EXTENSIONS = exports.ENDPOINT_REST_APPS_INSTALLATIONS = exports.ENDPOINT_REST_APPS = exports.ENDPOINT_WORKSPACE_MEMBERS = exports.ENDPOINT_PRICING = exports.ENDPOINT_PRICES = exports.ENDPOINT_WORKSPACE_BILLING_PORTAL = exports.ENDPOINT_WORKSPACE_TRIAL = exports.ENDPOINT_WORKSPACE_UPGRADE = exports.ENDPOINT_PRO_PLAN_DETAILS = exports.ENDPOINT_PRO_BILLING_PORTAL = exports.ENDPOINT_PRO_TRIAL = exports.ENDPOINT_PRO_UPGRADE = exports.ENDPOINT_PAYMENTS_REACTIVATE_PLAN = exports.ENDPOINT_PAYMENTS_CANCEL_PLAN = exports.ENDPOINT_PAYMENTS_SUBSCRIPTION_INFO = exports.ENDPOINT_WORKSPACE_USERS = exports.ENDPOINT_WORKSPACE_PLAN_DETAILS = exports.ENDPOINT_WORKSPACE_LOGO = exports.ENDPOINT_WORKSPACE_JOIN = exports.ENDPOINT_WORKSPACE_INVITATIONS_DELETE = exports.ENDPOINT_WORKSPACE_INVITATIONS_ALL = exports.ENDPOINT_WORKSPACE_INVITATIONS = exports.ENDPOINT_REST_WORKSPACES = exports.ENDPOINT_REST_FOLDERS = exports.ENDPOINT_REGISTER = exports.ENDPOINT_REVOKE = exports.ENDPOINT_GET_TOKEN = exports.ENDPOINT_AUTHORIZATION = exports.ENDPOINT_SYNC = exports.ENDPOINT_SYNC_QUICK_ADD = exports.ENDPOINT_REST_MOVED_IDS = void 0;
exports.getSyncBaseUri = getSyncBaseUri;
exports.getApiRootBaseUri = getApiRootBaseUri;
...
exports.getAppEndpoint = getAppEndpoint;
exports.getAppSecretsEndpoint = getAppSecretsEndpoint;
exports.getAppClientSecretEndpoint = getAppClientSecretEndpoint;
exports.getAppTokensEndpoint = getAppTokensEndpoint;
exports.getAppTestTokenEndpoint = getAppTestTokenEndpoint;
exports.getAppDistributionTokenEndpoint = getAppDistributionTokenEndpoint;
exports.getAppVerificationTokenEndpoint = getAppVerificationTokenEndpoint;
exports.getAppWebhookEndpoint = getAppWebhookEndpoint;
exports.getAppIconEndpoint = getAppIconEndpoint;
exports.getAppInstallationEndpoint = getAppInstallationEndpoint;
exports.getAppByDistributionTokenEndpoint = getAppByDistributionTokenEndpoint;
exports.getUiExtensionEndpoint = getUiExtensionEndpoint;
exports.getUiExtensionIconEndpoint = getUiExtensionIconEndpoint;
exports.getUiExtensionsByIntegrationEndpoint = getUiExtensionsByIntegrationEndpoint;
...
function getApiRootBaseUri(domainBase = BASE_URI) {
...
exports.ENDPOINT_REGISTER = 'register';
...
// Billing endpoints
exports.ENDPOINT_PAYMENTS_SUBSCRIPTION_INFO = 'payments/get_subscription_info';
exports.ENDPOINT_PAYMENTS_CANCEL_PLAN = 'payments/cancel_plan_with_redirect_to_stripe';
exports.ENDPOINT_PAYMENTS_REACTIVATE_PLAN = 'payments/reactivate_plan';
exports.ENDPOINT_PRO_UPGRADE = 'pro/upgrade';
exports.ENDPOINT_PRO_TRIAL = 'pro/trial';
exports.ENDPOINT_PRO_BILLING_PORTAL = 'pro/billing_portal';
exports.ENDPOINT_PRO_PLAN_DETAILS = 'pro/plan_details';
exports.ENDPOINT_WORKSPACE_UPGRADE = 'workspaces/upgrade';
exports.ENDPOINT_WORKSPACE_TRIAL = 'workspaces/trial';
exports.ENDPOINT_WORKSPACE_BILLING_PORTAL = 'workspaces/billing_portal';
exports.ENDPOINT_PRICES = 'prices';
exports.ENDPOINT_PRICING = 'pricing';
...
exports.ENDPOINT_REST_APPS = 'apps';
exports.ENDPOINT_REST_APPS_INSTALLATIONS = 'apps/installations';
exports.ENDPOINT_REST_APPS_UI_EXTENSIONS = 'apps/ui_extensions';
exports.ENDPOINT_REST_APPS_UI_EXTENSIONS_INSTALLED = 'apps/ui_extensions/installed';
exports.ENDPOINT_REST_USER_AUTHORIZATIONS = 'user/authorizations';
exports.ENDPOINT_REST_USER_AUTHORIZATIONS_DELETE = 'user/authorizations/delete';
/** Available app icon sizes (small 60x60, medium 300x300, large 600x600). */
exports.APP_ICON_SIZES = ['small', 'medium', 'large'];
function getAppEndpoint(appId) {
    return `apps/${appId}`;
}
function getAppSecretsEndpoint(appId) {
    return `apps/${appId}/secrets`;
}
function getAppClientSecretEndpoint(appId) {
    return `apps/${appId}/client_secret`;
}
function getAppTokensEndpoint(appId) {
    return `apps/${appId}/tokens`;
}
function getAppTestTokenEndpoint(appId) {
    return `apps/${appId}/test_token`;
}
function getAppDistributionTokenEndpoint(appId) {
    return `apps/${appId}/distribution_token`;
}
function getAppVerificationTokenEndpoint(appId) {
    return `apps/${appId}/verification_token`;
}
function getAppWebhookEndpoint(appId) {
    return `apps/${appId}/webhook`;
}
function getAppIconEndpoint(appId, size) {
    return size === 'medium' ? `apps/${appId}/icon` : `apps/${appId}/icon/${size}`;
}
function getAppInstallationEndpoint(installationId) {
    return `apps/installations/${installationId}`;
}
function getAppByDistributionTokenEndpoint(distributionToken) {
    return `apps/by_distribution_token/${distributionToken}`;
}
function getUiExtensionEndpoint(uiExtensionId) {
    return `apps/ui_extensions/${uiExtensionId}`;
}
function getUiExtensionIconEndpoint(uiExtensionId) {
    return `apps/ui_extensions/${uiExtensionId}/icon`;
}
function getUiExtensionsByIntegrationEndpoint(integrationId) {
