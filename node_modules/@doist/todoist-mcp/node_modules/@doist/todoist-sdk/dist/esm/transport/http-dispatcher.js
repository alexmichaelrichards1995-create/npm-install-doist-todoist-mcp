...
export async function getDefaultDispatcher() {
    var _a;
    return (_a = (await getDefaultTransport())) === null || _a === void 0 ? void 0 : _a.dispatcher;
}
/**
...
export async function resetDefaultDispatcherForTests() {
    ...
    defaultTransport = undefined;
    defaultTransportPromise = undefined;
    await transportPromise.then((transport) => transport.dispatcher.close(), () => undefined);
}
