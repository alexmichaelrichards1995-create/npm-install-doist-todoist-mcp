...
import { UI_EXTENSION_TYPES } from '../ui-extensions/types.js';
/**
 * Available statuses for a developer application.
 */
export const APP_STATUSES = ['public'];
 ...
 */
export function webhookEventFromWireName(wireName) {
    ...
    return wireName.slice(2).replace('_', ':');
}
/**
 * Translates a pretty event name (`'item:added'`) to its wire-format form (`'e_item_added'`).
 */
export function webhookEventToWireName(event) {
    return ('e_' + event.replace(':', '_'));
}
/**
 * Available statuses for an app webhook.
 */
export const WEBHOOK_STATUSES = ['active', 'invalid'];
