import { z } from 'zod';
import { type SyncResponse } from '../types/sync/response.js';
...
export declare const validateTask: (input: unknown) => {
    ...
    dayOrder: number;
    isCollapsed: boolean;
}, validateTaskArray: (input: unknown) => {
    isUncompletable: boolean;
    url: string;
    id: string;
    userId: string;
 ...
 */
export declare const validateProject: (input: unknown) => {
    url: string;
    id: string;
...
}, validateProjectArray: (input: unknown) => ({
    url: string;
    id: string;
    canAssignTasks: boolean;
    childOrder: number;
...
export declare const validateWorkspaceProject: (input: unknown) => {
    url: string;
    id: string;
    canAssignTasks: boolean;
    childOrder: number;
...
}, validateWorkspaceProjectArray: (input: unknown) => {
    url: string;
    id: string;
    canAssignTasks: boolean;
    childOrder: number;
...
export declare const validateSection: (input: unknown) => {
    ...
    isDeleted: boolean;
    isCollapsed: boolean;
}, validateSectionArray: (input: unknown) => {
    url: string;
    id: string;
    userId: string;
    projectId: string;
...
export declare const validateLabel: (input: unknown) => {
    ...
    color: string;
    isFavorite: boolean;
}, validateLabelArray: (input: unknown) => {
    id: string;
    order: number | null;
    name: string;
    color: string;
...
}, validateCommentArray: (input: unknown) => {
    taskId: string | undefined;
    id: string;
    content: string;
    postedAt: Date;
...
export declare const validateUser: (input: unknown) => {
    ...
    name: string;
    email: string;
}, validateUserArray: (input: unknown) => {
    id: string;
    name: string;
    email: string;
}[];
export declare const validateProductivityStats: (input: unknown) => {
    ...
    goals: {
        ...
        dailyGoal: number;
        ignoreDays: ("Monday" | "Tuesday" | "Wednesday" | "Thursday" | "Friday" | "Saturday" | "Sunday")[];
...
}, validateActivityEventArray: (input: unknown) => {
    [x: string]: any;
    objectType: string;
    objectId: string;
    eventType: string;
...
export declare const validateWorkspaceUser: (input: unknown) => {
    ...
    imageId: string | null;
    isDeleted: boolean;
}, validateWorkspaceUserArray: (input: unknown) => {
    userId: string;
    workspaceId: string;
    userEmail: string;
    fullName: string;
...
}, validateWorkspaceInvitationArray: (input: unknown) => {
    id: string;
    inviterId: string;
    userEmail: string;
    workspaceId: string;
...
}, validateWorkspaceArray: (input: unknown) => {
    createdAt: Date | undefined;
    id: string;
    name: string;
    plan: "STARTER" | "BUSINESS";
...
export declare const validateMemberActivityInfo: (input: unknown) => {
    ...
    tasksOverdue: number;
}, validateMemberActivityInfoArray: (input: unknown) => {
    userId: string;
    tasksAssigned: number;
    tasksOverdue: number;
}[];
export declare const validateWorkspaceUserTask: (input: unknown) => {
    ...
    description: string;
    isOverdue: boolean;
}, validateWorkspaceUserTaskArray: (input: unknown) => {
    id: string;
    content: string;
    responsibleUid: string | null;
    due: {
...
export declare const validateBackup: (input: unknown) => {
    version: string;
    url: string;
}, validateBackupArray: (input: unknown) => {
    version: string;
    url: string;
}[];
export declare const validateIdMapping: (input: unknown) => {
    oldId: string | null;
    newId: string | null;
}, validateIdMappingArray: (input: unknown) => {
    oldId: string | null;
    newId: string | null;
}[];
export declare const validateMovedId: (input: unknown) => {
    oldId: string;
    newId: string;
}, validateMovedIdArray: (input: unknown) => {
    oldId: string;
    newId: string;
}[];
export declare const validateFilter: (input: unknown) => {
    ...
    isFrozen: boolean;
    itemOrder: number;
}, validateFilterArray: (input: unknown) => {
    [x: string]: unknown;
    id: string;
    name: string;
    query: string;
...
export declare const validateCollaborator: (input: unknown) => {
    ...
    timezone: string;
    imageId: string | null;
}, validateCollaboratorArray: (input: unknown) => {
    [x: string]: unknown;
    id: string;
    email: string;
    fullName: string;
...
}, validateCollaboratorStateArray: (input: unknown) => {
    [x: string]: unknown;
    userId: string;
    projectId: string;
    state: "active" | "invited";
...
export declare const validateFolder: (input: unknown) => {
    ...
    defaultOrder: number;
    childOrder: number;
}, validateFolderArray: (input: unknown) => {
    [x: string]: unknown;
    id: string;
    name: string;
    workspaceId: string;
...
export declare const validateSubscriptionInfo: (input: unknown) => {
...
export declare const validateProPlanDetails: (input: unknown) => {
    currentPlanStatus: "Active" | "Downgraded" | "Cancelled" | "NeverSubscribed";
    downgradeAt: string | null;
    priceList: {
...
export declare const validatePrices: (input: unknown) => {
    pro: {
        billingCycle: "monthly" | "yearly";
        prices: {
            currency: string;
...
export declare const validatePricing: (input: unknown) => {
    [x: string]: Record<string, Record<string, {
...
export declare const validateNote: (input: unknown) => {
    ...
    projectId?: string | undefined;
}, validateNoteArray: (input: unknown) => {
    [x: string]: unknown;
    id: string;
    content: string;
    postedAt: Date;
...
export declare const validateWorkspaceFilter: (input: unknown) => {
    ...
    createdAt: Date;
    updatedAt: Date;
}, validateWorkspaceFilterArray: (input: unknown) => {
    [x: string]: unknown;
    id: string;
    workspaceId: string;
    name: string;
...
}, validateCalendarArray: (input: unknown) => {
    [x: string]: unknown;
    id: string;
    summary: string;
    color: string | null;
...
}, validateCalendarAccountArray: (input: unknown) => {
    [x: string]: unknown;
    id: string;
    name: string;
    type: "google" | "microsoft" | "apple";
...
export declare const validateReminder: (input: unknown) => {
    ...
    isUrgent?: boolean | undefined;
}, validateReminderArray: (input: unknown) => ({
    [x: string]: unknown;
    id: string;
    notifyUid: string;
    itemId: string;
...
export declare const validateLocationReminder: (input: unknown) => {
    ...
    radius: number;
    projectId?: string | undefined;
}, validateLocationReminderArray: (input: unknown) => {
    [x: string]: unknown;
    id: string;
    notifyUid: string;
    itemId: string;
...
export declare const validateCompletedInfo: (input: unknown) => {
    ...
    completedItems: number;
    id?: string | undefined;
}, validateCompletedInfoArray: (input: unknown) => ({
    [x: string]: unknown;
    projectId: string;
    archivedSections: number;
    completedItems: number;
...
export declare const validateViewOptions: (input: unknown) => {
    ...
    sortedBy?: "PROJECT" | "ASSIGNEE" | "ADDED_DATE" | "DUE_DATE" | "DEADLINE" | "PRIORITY" | "WORKSPACE" | "MANUAL" | "ALPHABETICALLY" | null | undefined;
    sortOrder?: "ASC" | "DESC" | null | undefined;
}, validateViewOptionsArray: (input: unknown) => {
    [x: string]: unknown;
    viewType: "PROJECT" | "TODAY" | "UPCOMING" | "LABEL" | "FILTER" | "WORKSPACE_FILTER" | "SEARCH" | "TEMPLATE_PREVIEW" | "TASK_DETAIL" | "AUTOMATION" | "ASSIGNED" | "OVERDUE" | "WORKSPACE_OVERVIEW";
    objectId?: string | undefined;
    groupedBy?: "PROJECT" | "LABEL" | "ASSIGNEE" | "ADDED_DATE" | "DUE_DATE" | "DEADLINE" | "PRIORITY" | "WORKSPACE" | null | undefined;
...
}, validateProjectViewOptionsDefaultsArray: (input: unknown) => {
    [x: string]: unknown;
    projectId: string;
    viewMode?: "LIST" | "BOARD" | "CALENDAR" | null | undefined;
    groupedBy?: "PROJECT" | "LABEL" | "ASSIGNEE" | "ADDED_DATE" | "DUE_DATE" | "DEADLINE" | "PRIORITY" | "WORKSPACE" | null | undefined;
...
}, validateLiveNotificationArray: (input: unknown) => {
    [x: string]: unknown;
    id: string;
    createdAt: Date;
    fromUid: string;
...
export declare const validateSyncWorkspace: (input: unknown) => {
    ...
    domainDiscovery?: boolean | null | undefined;
    restrictEmailDomains?: boolean | null | undefined;
    projectSortPreference?: string | null | undefined;
    defaultCollaborators?: {
        predefinedGroupIds: string[];
        userIds: string[];
    } | undefined;
    properties?: Record<string, unknown> | undefined;
}, validateSyncWorkspaceArray: (input: unknown) => {
    createdAt: Date | undefined;
    id: string;
    name: string;
    description: string;
...
export declare const validateSyncUser: (input: unknown) => {
    ...
    dateistLang?: string | null | undefined;
    freeTrailExpires?: Date | undefined;
    hasStartedATrial?: boolean | undefined;
    mfaEnabled?: boolean | undefined;
    mobileHost?: string | null | undefined;
...
export declare const validateUserSettings: (input: unknown) => {
    ...
    debugLogSendingEnabledUntil?: string | null | undefined;
...
export declare const validateSuggestion: (input: unknown) => {
    ...
    isDeleted: boolean;
}, validateSuggestionArray: (input: unknown) => ({
    [x: string]: unknown;
    type: "templates" | "most_used_user_templates";
    content: {
        templates: {
...
export declare function parseSyncResponse(raw: Record<string, unknown>): SyncResponse;
export declare const validateApp: (input: unknown) => {
    id: string;
    clientId: string;
    status: "public";
    displayName: string;
...
}, validateAppArray: (input: unknown) => {
    id: string;
    clientId: string;
    status: "public";
    displayName: string;
...
export declare const validateAppWithUserCount: (input: unknown) => {
    id: string;
    clientId: string;
    status: "public";
    displayName: string;
...
export declare const validateAppSecrets: (input: unknown) => {
    clientId: string;
    clientSecret: string;
};
export declare const validateAppVerificationToken: (input: unknown) => {
    verificationToken: string;
};
export declare const validateAppTestToken: (input: unknown) => {
    accessToken?: string | null | undefined;
};
export declare const validateAppDistributionToken: (input: unknown) => {
    distributionToken: string;
};
export declare const validateAppByDistributionToken: (input: unknown) => {
    id: string;
    displayName: string;
    description: string | null;
    iconMd: string | null;
...
export declare const validateAppWebhook: (input: unknown) => {
...
export declare const validateAppInstallation: (input: unknown) => {
    id: string;
    creator: string;
    createdTs: number;
...
}, validateAppInstallationArray: (input: unknown) => {
    id: string;
    creator: string;
    createdTs: number;
    installationType: "user";
...
export declare const validateUserAuthorization: (input: unknown) => {
...
}, validateUserAuthorizationArray: (input: unknown) => {
    accessTokenId: string;
    scope: string[];
    scopeDescriptions: string[];
    createdAt: Date;
...
export declare const validateUiExtension: (input: unknown) => {
    id: string;
...
}, validateUiExtensionArray: (input: unknown) => ({
    id: string;
    integrationId: string;
    extensionId: string;
    url: string;
