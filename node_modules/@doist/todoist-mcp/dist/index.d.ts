...
declare const tools: {
    ...
    updateTasks: {
        ...
        parameters: {
            tasks: import('zod').ZodArray<import('zod').ZodObject<{
                ...
                duration: import('zod').ZodOptional<import('zod').ZodString>;
                responsibleUser: import('zod').ZodOptional<import('zod').ZodPipe<import('zod').ZodTransform<{} | undefined, unknown>, import('zod').ZodString>>;
                labels: import('zod').ZodOptional<import('zod').ZodArray<import('zod').ZodString>>;
                isUncompletable: import('zod').ZodOptional<import('zod').ZodBoolean>;
            }, import('zod/v4/core').$strip>>;
        };
        outputSchema: {
            ...
            appliedOperations: import('zod').ZodObject<{
                ...
                failureCount: import('zod').ZodNumber;
                redundantMovesSkipped: import('zod').ZodNumber;
            }, import('zod/v4/core').$strip>;
        };
        annotations: {
            readOnlyHint: false;
    ...
    findActivity: {
        ...
        parameters: {
            ...
            dateFrom: import('zod').ZodPipe<import('zod').ZodOptional<import('zod').ZodPipe<import('zod').ZodString, import('zod').ZodTransform<string | undefined, string>>>, import('zod').ZodOptional<import('zod').ZodUnion<readonly [import('zod').ZodISODate, import('zod').ZodISODateTime]>>>;
            dateTo: import('zod').ZodPipe<import('zod').ZodOptional<import('zod').ZodPipe<import('zod').ZodString, import('zod').ZodTransform<string | undefined, string>>>, import('zod').ZodOptional<import('zod').ZodUnion<readonly [import('zod').ZodISODate, import('zod').ZodISODateTime]>>>;
            limit: import('zod').ZodDefault<import('zod').ZodNumber>;
            cursor: import('zod').ZodOptional<import('zod').ZodString>;
        };
        outputSchema: {
