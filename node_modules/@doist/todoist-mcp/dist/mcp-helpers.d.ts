 ...
 */
declare function stripEmailsFromObject<T>(obj: T): T;
/**
 * Strips email patterns from text content.
 * Replaces email addresses with [email hidden] placeholder.
 */
declare function stripEmailsFromText(text: string): string;
/**
 * Register a Todoist tool in an MCP server.
 */
declare function registerTool({ tool, server, client, features, }: {
    tool: AnyTodoistTool;
    server: McpServer;
    client: TodoistApi;
    features?: Features;
}): void;
export { FEATURE_NAMES, type Feature, type FeatureName, type Features, registerTool, stripEmailsFromObject, stripEmailsFromText, };
