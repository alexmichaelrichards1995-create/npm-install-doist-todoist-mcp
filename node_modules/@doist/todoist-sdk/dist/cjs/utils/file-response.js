...
exports.wrapAsFileResponse = wrapAsFileResponse;
 ...
 */
function wrapAsFileResponse(response, context) {
    const headers = response.headers instanceof Headers ? (0, headers_1.headersToRecord)(response.headers) : response.headers;
    return {
        ok: response.ok,
