...
exports.FeaturesSchema = zod_1.z.looseObject({
...
exports.TzInfoSchema = zod_1.z.looseObject({
...
exports.JoinableWorkspaceSchema = zod_1.z.looseObject({
    workspaceId: zod_1.z.string(),
    workspaceName: zod_1.z.string(),
    memberCount: zod_1.z.number().int(),
});
exports.GettingStartedGuideProjectSchema = zod_1.z.looseObject({
 ...
 */
exports.SyncUserSchema = zod_1.z.looseObject({
    id: zod_1.z.string(),
    ...
    mobileHost: zod_1.z.string().nullish(),
    mobileNumber: zod_1.z.string().nullish(),
