...
const user_preferences_1 = require("../sync/user-preferences");
...
exports.ProductivityStatsSchema = zod_1.z.object({
    ...
    goals: zod_1.z.object({
        ...
        ignoreDays: zod_1.z.array(user_preferences_1.DayOfWeekSchema),
        karmaDisabled: user_preferences_1.BooleanFromZeroOneSchema,
        ...
        vacationMode: user_preferences_1.BooleanFromZeroOneSchema,
