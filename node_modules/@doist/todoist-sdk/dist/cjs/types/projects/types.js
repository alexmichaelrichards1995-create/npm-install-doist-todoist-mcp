...
exports.PROJECT_VIEW_STYLES = exports.ProjectSchema = exports.WorkspaceProjectSchema = exports.ProjectVisibilitySchema = exports.PROJECT_VISIBILITIES = exports.PersonalProjectSchema = exports.BaseProjectSchema = void 0;
 ...
 */
exports.ProjectSchema = zod_1.z.unknown().transform((val) => {
    if (typeof val === 'object' && val !== null && 'workspaceId' in val) {
        return exports.WorkspaceProjectSchema.parse(val);
    }
    return exports.PersonalProjectSchema.parse(val);
});
