...
const file_response_1 = require("../utils/file-response");
 ...
 * JSDoc.
 */
class UploadClient extends base_client_1.BaseClient {
    ...
    async viewAttachment(commentOrUrl) {
        ...
        if (this.customFetch) {
            ...
            return (0, file_response_1.wrapAsFileResponse)(response, 'viewAttachment');
        }
