    ...
    for (let attempt = 0; attempt <= config.retries; attempt++) {
        ...
        try {
            ...
            if (customFetch) {
                ...
                const transport = await (0, http_dispatcher_1.getDefaultTransport)();
                const nativeFetchOptions = Object.assign(Object.assign({}, fetchOptions), { signal: requestSignal });
                if ((transport === null || transport === void 0 ? void 0 : transport.dispatcher) !== undefined) {
                ...
                const fetchImpl = ((_a = transport === null || transport === void 0 ? void 0 : transport.fetch) !== null && _a !== void 0 ? _a : fetch);
