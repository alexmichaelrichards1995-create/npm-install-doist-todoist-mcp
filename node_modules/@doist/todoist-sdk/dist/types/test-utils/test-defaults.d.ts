import { Label, Section, Task, User, Attachment, Duration, Deadline, RawComment, PersonalProject, WorkspaceProject, Reminder, Folder, App, AppWithUserCount, AppSecrets, AppVerificationToken, AppTestToken, AppDistributionToken, AppWebhook, AppInstallation, UserAuthorization, UiExtension } from '../types/index.js';
import type { Collaborator, CollaboratorState } from '../types/sync/resources/collaborators.js';
import type { Note } from '../types/sync/resources/notes.js';
...
export declare const DEFAULT_WORKSPACE_PROJECT: WorkspaceProject;
...
export declare const DEFAULT_COLLABORATOR: Collaborator;
export declare const DEFAULT_COLLABORATOR_STATE: CollaboratorState;
export declare const DEFAULT_APP_ID = "42";
export declare const DEFAULT_INSTALLATION_ID = "1001";
export declare const DEFAULT_UI_EXTENSION_ID = "2002";
export declare const DEFAULT_DISTRIBUTION_TOKEN = "dist-token-abc";
export declare const DEFAULT_ACCESS_TOKEN_ID = "3003";
export declare const DEFAULT_APP: App;
export declare const DEFAULT_APP_WITH_USER_COUNT: AppWithUserCount;
export declare const DEFAULT_APP_SECRETS: AppSecrets;
export declare const DEFAULT_APP_VERIFICATION_TOKEN: AppVerificationToken;
export declare const DEFAULT_APP_TEST_TOKEN: AppTestToken;
export declare const DEFAULT_APP_DISTRIBUTION_TOKEN: AppDistributionToken;
export declare const DEFAULT_APP_WEBHOOK: AppWebhook;
export declare const DEFAULT_APP_INSTALLATION: AppInstallation;
export declare const DEFAULT_USER_AUTHORIZATION: UserAuthorization;
export declare const DEFAULT_UI_EXTENSION: UiExtension;
