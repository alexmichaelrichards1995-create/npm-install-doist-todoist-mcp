...
export function getApiRootBaseUri(domainBase = BASE_URI) {
...
export const APP_ICON_SIZES = ['small', 'medium', 'large'];
export function getAppEndpoint(appId) {
    return `apps/${appId}`;
}
export function getAppSecretsEndpoint(appId) {
    return `apps/${appId}/secrets`;
}
export function getAppClientSecretEndpoint(appId) {
    return `apps/${appId}/client_secret`;
}
export function getAppTokensEndpoint(appId) {
    return `apps/${appId}/tokens`;
}
export function getAppTestTokenEndpoint(appId) {
    return `apps/${appId}/test_token`;
}
export function getAppDistributionTokenEndpoint(appId) {
    return `apps/${appId}/distribution_token`;
}
export function getAppVerificationTokenEndpoint(appId) {
    return `apps/${appId}/verification_token`;
}
export function getAppWebhookEndpoint(appId) {
    return `apps/${appId}/webhook`;
}
export function getAppIconEndpoint(appId, size) {
    return size === 'medium' ? `apps/${appId}/icon` : `apps/${appId}/icon/${size}`;
}
export function getAppInstallationEndpoint(installationId) {
    return `apps/installations/${installationId}`;
}
export function getAppByDistributionTokenEndpoint(distributionToken) {
    return `apps/by_distribution_token/${distributionToken}`;
}
export function getUiExtensionEndpoint(uiExtensionId) {
    return `apps/ui_extensions/${uiExtensionId}`;
}
export function getUiExtensionIconEndpoint(uiExtensionId) {
    return `apps/ui_extensions/${uiExtensionId}/icon`;
}
export function getUiExtensionsByIntegrationEndpoint(integrationId) {
