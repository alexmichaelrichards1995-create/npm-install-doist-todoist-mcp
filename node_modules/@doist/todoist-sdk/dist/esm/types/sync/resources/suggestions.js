...
export const TemplateSuggestionSchema = z.looseObject({
    id: z.string(),
    name: z.string(),
...
export const SyncTemplateSuggestionsSchema = z.looseObject({
...
export const SyncWorkspaceTemplateSuggestionsSchema = z.looseObject({
