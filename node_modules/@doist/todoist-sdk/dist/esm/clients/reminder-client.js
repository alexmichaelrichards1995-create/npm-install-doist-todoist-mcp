import { ENDPOINT_REST_LOCATION_REMINDERS, ENDPOINT_REST_REMINDERS } from '../consts/endpoints.js';
...
import { ReminderIdSchema, UpdateLocationReminderArgsSchema, UpdateReminderArgsSchema, } from '../types/reminders/index.js';
import { ReminderTypeEnum } from '../types/sync/resources/reminders.js';
import { generatePath } from '../utils/request-helpers.js';
import { validateLocationReminderArray, validateReminder, validateReminderArray, } from '../utils/validators.js';
...
export class ReminderClient extends BaseClient {
    ...
    async addLocationReminder(args, requestId) {
        const response = await request({
            ...
            apiToken: this.authToken,
            customFetch: this.customFetch,
            payload: Object.assign(Object.assign({}, args), { reminderType: ReminderTypeEnum.Location }),
            requestId: requestId,
        });
        return validateReminder(response.data);
    }
